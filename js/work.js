...
function putImages3(arr) {
  picsInner3.innerHTML='';
  for (let i = 0; i < arr.length; i++) {
    picsInner3.innerHTML += `<div class="pImage">
    <img src="${URL.createObjectURL(arr[i])}" alt="">
    <i class="fa-light fa-trash-can" data-name="${arr[i].name}"></i>
  </div>`;
  }
